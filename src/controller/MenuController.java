...
public class MenuController implements ActionListener, CaretListener{
	...
	private void control() {
		...
		telaMenu.getDescricaoMenuItemCadastrar().addActionListener(this);
		telaMenu.getDescricaoMenuItemBuscar().addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==telaMenu.getDescricaoMenuItemBuscar()) {
			...
			telaMenu.getDescricaoPanel().setVisible(false);
			telaMenu.getBuscarDescricaoPanel().setVisible(true);
		}
		if(e.getSource()==telaMenu.getDescricaoMenuItemCadastrar()) {
			telaMenu.getFormularioCliente().setVisible(false);
			telaMenu.getFormularioCliente().getEnderecoPanel().setVisible(false);
			telaMenu.getFestaPanel().setVisible(false);
			telaMenu.getFestaPanel().getEnderecoPanel().setVisible(false);
