...
import util.SpringUtilities;
	...
	public class TelaMenu extends JFrame {
		...
		descricaoMenuItemBuscar, descricaoMenuItemCadastrar;
		...
		DescricaoPanel descricaoPanel;
		BuscarDescricaoPanel buscarDescricaoPanel;
		...
		public TelaMenu() {
			...
			descricaoMenuItemCadastrar = new JMenuItem("descricao da tema");
			descricaoMenuItemCadastrar.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.ALT_MASK));
			
			descricaoMenuItemBuscar = new JMenuItem("descricao de tema");
			descricaoMenuItemBuscar.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.ALT_MASK));
			...
			cadastrarMenu.add(descricaoMenuItemCadastrar);
			...
			buscarMenu.add(descricaoMenuItemBuscar);
			...
			descricaoPanel = new DescricaoPanel();
			descricaoPanel.setVisible(false);
			
			buscarDescricaoPanel= new BuscarDescricaoPanel();
			buscarDescricaoPanel.setVisible(false);
			...
			panelGeral.add(descricaoPanel);
			panelGeral.add(buscarDescricaoPanel);
		...
		public JMenuItem getDescricaoMenuItemBuscar() {
			return descricaoMenuItemBuscar;
		}

		public JMenuItem getDescricaoMenuItemCadastrar() {
			return descricaoMenuItemCadastrar;
		}

		public DescricaoPanel getDescricaoPanel() {
			return descricaoPanel;
		}

		public BuscarDescricaoPanel getBuscarDescricaoPanel() {
			return buscarDescricaoPanel;
		}
